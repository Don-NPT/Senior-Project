...
public class TopButton : MonoBehaviour
{
    ...
    void Awake()
    {
        // buttons = GetComponentsInChildren<GameObject>();
    ...
    void FixedUpdate()
    {
        if(GameManager.instance.gameState == GameState.PLAY){
            ...
            // buttons[0].GetComponentsInChildren<Image>()[1].color = selectedColor;
            // buttons[1].GetComponentsInChildren<Image>()[1].color = normalColor;
            // buttons[2].GetComponentsInChildren<Image>()[1].color = selectedColor;
            ...
            // buttons[0].GetComponentsInChildren<Image>()[1].color = normalColor;
            // buttons[1].GetComponentsInChildren<Image>()[1].color = selectedColor;
            // buttons[2].GetComponentsInChildren<Image>()[1].color = selectedColor;
            ...
            // buttons[0].GetComponentsInChildren<Image>()[1].color = selectedColor;
            // buttons[1].GetComponentsInChildren<Image>()[1].color = selectedColor;
            // buttons[2].GetComponentsInChildren<Image>()[1].color = normalColor;
        }
    }
}
